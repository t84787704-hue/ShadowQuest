...
const WORLDS: WorldNode[] = [
  {
    id: 1,
    name: 'WORLD 1',
    shortTitle: 'Nature Adventure',
    subtitle: 'Lush green forest & mountain fortress',
  ...
  },
  {
    ...
    name: 'WORLD 2',
    shortTitle: 'Desert',
    subtitle: 'Golden dunes, canyons & desert temple',
  ...
  },
  {
    ...
    name: 'WORLD 3',
    shortTitle: 'Ice',
    subtitle: 'Snow forest, frozen lake & ice fortress',
  ...
  },
  {
    ...
    name: 'WORLD 4',
    shortTitle: 'Volcano',
    subtitle: 'Volcanic valley, lava caves & magma fortress',
  ...
  },
  {
    id: 5,
    name: 'WORLD 5',
    shortTitle: 'Dark Lands',
    subtitle: 'Haunted forest, dark castle & final arena',
