...
export const BOSS_SPECS: Record<number, BossInfo> = {
  1: {
    name: 'GREEN VALLEY CHIEFTAIN',
    title: 'WORLD 1 GREEN VALLEY BOSS',
    worldId: 1,
    maxHp: 450,
    attackDamage: 8,
    baseSpeed: 2.2,
  ...
  2: {
    name: 'DESERT PHARAOH TITAN',
    title: 'WORLD 2 DESERT EMPIRE BOSS',
    worldId: 2,
    maxHp: 600,
    attackDamage: 9,
    baseSpeed: 2.0,
  ...
  3: {
    name: 'FROST COLOSSUS WARLORD',
    title: 'WORLD 3 FROZEN KINGDOM BOSS',
    worldId: 3,
    maxHp: 750,
    attackDamage: 10,
    baseSpeed: 3.0,
  ...
  4: {
    name: 'MAGMA OVERLORD',
    title: 'WORLD 4 VOLCANIC LANDS BOSS',
    worldId: 4,
    maxHp: 900,
    attackDamage: 10,
    baseSpeed: 2.7,
  ...
  5: {
    name: 'ANCIENT GUARDIAN MONARCH',
    title: 'WORLD 5 ANCIENT TEMPLE BOSS',
    worldId: 5,
    maxHp: 1100,
    attackDamage: 11,
    baseSpeed: 2.9,
  ...
  6: {
    name: 'SWAMP BEHEMOTH ARCHON',
    title: 'WORLD 6 DARK SWAMP BOSS',
    worldId: 6,
    maxHp: 1400,
    attackDamage: 12,
    baseSpeed: 2.8,
  ...
  7: {
    name: 'SKY CITADEL TITAN',
    title: 'WORLD 7 SKY FORTRESS BOSS',
    worldId: 7,
    maxHp: 1600,
    attackDamage: 13,
    baseSpeed: 3.1,
  ...
  8: {
    name: 'CURSED SPECTRAL KING',
    title: 'WORLD 8 CURSED CITY BOSS',
    worldId: 8,
    maxHp: 1800,
    attackDamage: 14,
    baseSpeed: 3.2,
  ...
  9: {
    name: 'DEMON ARCHON OVERLORD',
    title: 'WORLD 9 DEMON REALM BOSS',
    worldId: 9,
    maxHp: 2000,
    attackDamage: 15,
    baseSpeed: 3.0,
  ...
  10: {
    name: 'ULTIMATE OVERLORD SOVEREIGN',
    title: 'WORLD 10 FINAL REALM OVERLORD',
    worldId: 10,
    maxHp: 2500,
    attackDamage: 18,
    baseSpeed: 3.4,
