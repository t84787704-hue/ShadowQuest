...
export const BOSS_SPECS: Record<number, BossInfo> = {
  ...
  7: {
    name: 'PRISMATIC CRYSTAL GOLEM',
    title: 'WORLD 7 CRYSTAL SANCTUM WARDEN',
    worldId: 7,
    maxHp: 1600,
    attackDamage: 13,
    baseSpeed: 2.8,
  ...
  8: {
    name: 'STORM LORD TEMPEST',
    title: 'WORLD 8 SKY SOVEREIGN',
    worldId: 8,
    maxHp: 1800,
    attackDamage: 14,
    baseSpeed: 3.2,
  ...
  9: {
    name: 'KRAKEN BASIN MONARCH',
    title: 'WORLD 9 SUNKEN TEMPLE SOVEREIGN',
    worldId: 9,
    maxHp: 2000,
    attackDamage: 15,
    baseSpeed: 2.9,
  ...
  10: {
    ...
    title: 'WORLD 10 CELESTIAL PEAK FINAL FINALE',
    worldId: 10,
    maxHp: 2500,
    attackDamage: 18,
    baseSpeed: 3.4,
